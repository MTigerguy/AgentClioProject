...
def extract_base_filename(pdf_path):
    ...
    # --- Extended list of words/roles that should never be used as borrower names ---
    not_borrower_filters = [
        "lender", "lender name", "lender rep", "lender representative",
        "mortgage company", "bank", "servicer", "broker", "realty",
        "real estate agent", "title", "title agent", "title rep", "title company",
        "escrow officer", "settlement agent", "notary", "witness", "signature",
        "loan officer", "processor", "signing agent", "closing agent",
        "underwriter", "attorney", "law firm", "company", "inc", "llc", "corp",
        "approved", "accept", "accepted", "north charleston", "charleston", "clearedge",
        "seller", "buyer", "applicant", "client", "customer", "agent",
